<header
    ...
    <button @click="sidebarOpen = true"
        class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition hover:bg-gray-50 lg:hidden">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                @if ($userHospitals->count() > 1)
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100"
                        ...
                        class="absolute left-0 top-full z-50 mt-1 w-56 rounded-xl border border-gray-200 bg-white py-1 shadow-lg"
                        style="display:none;">
    ...
    {{-- <div
        class="hidden flex-1 items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 sm:flex sm:max-w-xs">
    ...
    <div class="ml-auto flex items-center gap-2">
        ...
        {{-- Search icon mobile --}}
        {{-- <button class="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white sm:hidden">
        ...
        <div class="relative">
            <button
                class="relative flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white transition hover:bg-gray-50">
                <svg class="h-4 w-4 text-gray-500" fill="none" stroke="currentColor" stroke-width="2"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
