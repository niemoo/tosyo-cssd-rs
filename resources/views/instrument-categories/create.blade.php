<x-layouts.app title="Tambah Kategori Instrumen">
    ...
    <x-slot name="pageHeader">Tambah Kategori Instrumen</x-slot>
    <x-slot name="pageSubHeader">Tambahkan kategori baru untuk mengelompokkan instrumen</x-slot>

    <form method="POST" action="{{ route('instrument-categories.store') }}">
        @csrf
                       ...
                       {{ $errors->has('hospital_id') ? 'border-red-400' : 'border-gray-200' }}">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                placeholder="cth. Instrumen Bedah"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" placeholder="cth. CAT-BDH"
                                class="w-full rounded-lg border bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-300 transition
                                          focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" rows="3" placeholder="Deskripsi singkat kategori ini..."
                                class="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-300 transition
                                             focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20">{{ old('description') }}</textarea>
                        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="rounded-xl border border-green-100 bg-primary-50 p-4">
                    ...
                    <ul class="space-y-1.5 text-xs text-primary-700">
                        ...
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Contoh kategori: Bedah, Obstetri,
                            Ortopedi</li>
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Deskripsi opsional tapi
                            direkomendasikan</li>
                    </ul>
                </div>
