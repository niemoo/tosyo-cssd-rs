<x-layouts.app title="Tambah Kategori Consumable">
    ...
    <x-slot name="pageHeader">Tambah Kategori Consumable</x-slot>
    <x-slot name="pageSubHeader">Tambahkan kategori baru untuk mengelompokkan consumable</x-slot>

    <form method="POST" action="{{ route('consumable-categories.store') }}">
        @csrf
                    ...
                    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                placeholder="cth. Pouch Sterilisasi"
            ...
            <div class="space-y-4">
                ...
                <div class="rounded-xl border border-green-100 bg-primary-50 p-4">
                    ...
                    <ul class="space-y-1.5 text-xs text-primary-700">
                        ...
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Contoh: Pouch, Indikator, Detergent
                        </li>
                    </ul>
                </div>
