<x-layouts.app title="Edit — {{ $hospital->name }}">
    ...
    <x-slot name="breadcrumb">
        ...
        <a href="{{ route('hospitals.show', $hospital) }}" class="hover:text-gray-600">{{ $hospital->name }}</a>
        <svg class="h-3 w-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 18l6-6-6-6" />
        </svg>
    ...
    <x-slot name="pageHeader">Edit Rumah Sakit</x-slot>
    <x-slot name="pageSubHeader">{{ $hospital->name }}</x-slot>
    ...
    <form method="POST" action="{{ route('hospitals.update', $hospital) }}">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $hospital->code }}" disabled
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="address" rows="3"
                                class="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 transition
                                             focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20">{{ old('address', $hospital->address) }}</textarea>
                        </div>
            ...
            <div class="space-y-4">
                ...
                {{-- Submit di sidebar — di dalam form --}}
                <button type="submit"
