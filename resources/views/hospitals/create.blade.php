<x-layouts.app title="Tambah Rumah Sakit">
    ...
    <x-slot name="pageHeader">Tambah Rumah Sakit</x-slot>
    <x-slot name="pageSubHeader">Daftarkan cabang rumah sakit baru ke dalam sistem</x-slot>
                    ...
                    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                placeholder="cth. RS Sehat Jaya Pusat"
                        ...
                        <div>
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" placeholder="cth. RSJ-001"
                                class="w-full rounded-lg border bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-300 transition
                                          focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20
                            ...
                            @error('code')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-[10px] text-gray-400">Kode unik, tidak bisa diubah setelah disimpan</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('phone') }}"
                                placeholder="cth. 0215551001" inputmode="numeric" pattern="[0-9]*"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="address" rows="3" placeholder="Alamat lengkap rumah sakit..."
                                class="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-300 transition
                                             focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20">{{ old('address') }}</textarea>
                        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="p-5">
                        <div
                            ...
                            <div>
                                <div class="text-sm font-medium text-gray-900">Rumah Sakit Aktif</div>
                ...
                <div class="rounded-xl border border-green-100 bg-primary-50 p-4">
                    ...
                    <ul class="space-y-1.5 text-xs text-primary-700">
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Kode RS harus unik dan singkat</li>
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Format kode: singkatan RS + nomor urut
                        </li>
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Setelah disimpan, tambahkan unit dan
                            pengguna</li>
                    </ul>
                </div>

                {{-- Tombol Simpan — konsisten dengan edit.blade.php --}}
                <button type="submit"
