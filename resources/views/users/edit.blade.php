<x-layouts.app title="Edit — {{ $user->name }}">
    ...
    <x-slot name="breadcrumb">
        ...
        <a href="{{ route('users.show', $user) }}" class="hover:text-gray-600">{{ $user->name }}</a>
        <svg class="h-3 w-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 18l6-6-6-6" />
        </svg>
    ...
    <x-slot name="pageHeader">Edit Pengguna</x-slot>
    <x-slot name="pageSubHeader">{{ $user->name }}</x-slot>
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-[10px] text-gray-400">Username tidak dapat diubah</p>
                        </div>
                            ...
                            @foreach ($hospitals as $hospital)
                                <label
                                    ...
                                    <input type="checkbox" name="hospital_ids[]" value="{{ $hospital->id }}"
                                        {{ in_array($hospital->id, old('hospital_ids', $userHospitalIds)) ? 'checked' : '' }}
