<x-layouts.app title="Buat Permintaan Distribusi">
    ...
    <x-slot name="breadcrumb">
        ...
        <span class="text-gray-700">Buat Permintaan</span>
    </x-slot>

    <x-slot name="pageHeader">Buat Permintaan Distribusi</x-slot>
    <x-slot name="pageSubHeader">Ajukan permintaan tray untuk unit/bangsal</x-slot>

    <form method="POST" action="{{ route('distribution-requests.store') }}" x-data="{
        items: [{ template_id: '', quantity: 1, notes: '' }],
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="notes" rows="2" placeholder="cth. Untuk operasi elektif besok pagi"
            ...
            <div class="space-y-4">
                ...
                <div class="rounded-xl border border-green-100 bg-primary-50 p-4">
                    ...
                    <ul class="space-y-1.5 text-xs text-primary-700">
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Simpan sebagai draft untuk diedit
                            nanti</li>
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Ajukan untuk dikirim ke supervisor
                        </li>
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Template bersifat hint — CSSD akan
                            assign tray sesuai ketersediaan</li>
                    </ul>
                </div>
