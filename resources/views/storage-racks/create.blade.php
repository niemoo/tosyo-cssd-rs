<x-layouts.app title="Tambah Rak Penyimpanan">
    ...
    <x-slot name="pageHeader">Tambah Rak Penyimpanan</x-slot>
    <x-slot name="pageSubHeader">Tambahkan rak penyimpanan baru untuk tray steril</x-slot>

    <form method="POST" action="{{ route('storage-racks.store') }}">
        @csrf
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="cth. Rak A1"
                        ...
                        <div>
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" placeholder="cth. RK-A1"
                                class="w-full rounded-lg border bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-300 transition
                                          focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20
                        ...
                        <div>
                            ...
                            <input type="number" name="capacity" value="{{ old('capacity') }}" placeholder="cth. 20"
                                min="1"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="location_desc" value="{{ old('location_desc') }}"
                                placeholder="cth. Ruang Steril Lantai 2, dekat pintu masuk"
                                class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-300 transition
                                          focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-400/20" />
                        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="rounded-xl border border-green-100 bg-primary-50 p-4">
                    ...
                    <ul class="space-y-1.5 text-xs text-primary-700">
                        ...
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Kapasitas dalam jumlah tray yang dapat
                            disimpan</li>
                        <li class="flex gap-1.5"><span class="shrink-0">•</span>Deskripsi lokasi memudahkan pencarian
                            fisik</li>
                    </ul>
                </div>
